...
const GameCard = ({ game }: Props) => {
  ...
  return (
    <div className="flex flex-col rounded-xl lg:max-w-xs xl:max-w-md overflow-hidden dark:bg-[#202020] bg-gray-500 transition-transform duration-300 hover:scale-105">
